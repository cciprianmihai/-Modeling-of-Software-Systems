...
//Class - MainProject.ParkingLot - is used to define a Parking Lot
public class ParkingLot {
    ...
    // method for parking the MainProject.Vehicle
    ...
    // method for remove a MainProject.Vehicle
    ...
    public String toString(){
        ...
        for (int count = 0; count < NUM_OF_LEVELS; count++){
            sb.append("MainProject.Level " + count + ": " + levels[count] + "\n");
        } // end of for loop
        // return statement
        return sb.toString();
    } // end of toString method
} // end of MainProject.ParkingLot class